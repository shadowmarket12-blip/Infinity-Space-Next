...
const LivingRoomTestimonials = () => {
  const [activeTestimonial, setActiveTestimonial] = useState(0);
  const [isAutoPlaying, setIsAutoPlaying] = useState(true);

  const testimonials = [
    {
      name: "Ananya & Soumya Pattnaik",
      project: "Living Room + Dining Design",
      location: "Patia, Bhubaneswar",
      rating: 5,
      text: "What was a plain furniture-store living room became something from a design magazine. TV wall, cove lighting, feature wall — every element works together. Done in 28 days, on budget, with not a single surprise on the invoice.",
      initials: "AP",
      highlight: "On-time delivery",
    },
    {
      name: "Bijayalaxmi Mishra",
      project: "Living Room Interior Design",
      location: "Nayapalli, Bhubaneswar",
      rating: 5,
      text: "We wanted Odia-modern — cultural identity without looking old-fashioned. The Infinity Space team got it in the first meeting. The Kalinga panel wall, warm wooden TV unit, earthy palette — our living room now feels genuinely ours.",
      initials: "BM",
      highlight: "Cultural design",
    },
    {
...
export default LivingRoomTestimonials;
