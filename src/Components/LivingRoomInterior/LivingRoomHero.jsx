...
export default function LivingRoomHero() {
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/Livingherobanner.webp"
      ...
      <div className="relative z-10 mx-auto flex min-h-[90vh] max-w-[1450px] items-center px-4 py-28 sm:px-6 lg:px-14">
        <div className="max-w-4xl">
          ...
          >
            Living Room Interior Design in Bhubaneswar That Feels Completely,
            Beautifully Yours
          </motion.h1>
          ...
          <Link href="/">
            <motion.h2
              ...
              className="mt-6 max-w-3xl text-sm leading-6 text-white/90 sm:text-xl md:text-1xl"
            >
