...
export default function ModularKitchenHero() {
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/modular-kitchen-page/modern-modular-kitchen.webp"
          alt="Modular Kitchen Design in Bhubaneswar"
          fill
      ...
      <div className="relative z-10 mx-auto flex min-h-[90vh] max-w-[1450px] items-center px-4 py-28 sm:px-6 lg:px-14">
        <div className="max-w-4xl">
          ...
          >
            ...
            <FiChevronRight className="text-sm" />
            <span className="text-white/70">Modular Kitchen Design</span>
          </motion.div>
          ...
          >
            Modular Kitchen Design in Bhubaneswar — Smart Layouts, Premium
          ...
          <Link href="/">
            <motion.h2
              ...
              className="mt-6 max-w-3xl text-sm leading-9 text-white/90 sm:text-xl md:text-2xl"
            >
              Every layout. Every budget. Every detail handled — from the first
              measurement to the final fitting.
            </motion.h2>
          </Link>
            ...
            <Link href="/projects">
              ...
              >
                ...
                <div className="relative flex items-center gap-3 overflow-hidden rounded-[20px] bg-[rgba(1,101,63,1)] px-8 py-4 text-sm font-semibold tracking-wide text-white shadow-[0_20px_45px_rgba(1,101,63,0.35)]">
                  ...
                  <span className="relative z-10">View Kitchen Designs</span>
                </div>
              </motion.button>
            </Link>
