  ...
  const designSteps = [
    {
      ...
      icon: "🤝",
      description:
        "01 — Free Consultation	We visit, take precise measurements, assess ventilation and electrical points, and understand your storage needs, cooking habits, and budget",
    ...
    },
    {
      ...
      icon: "🎨",
      description:
        "Complete 3D renders of your kitchen — cabinet layout, shutter finish, countertop, appliance positions, and lighting — from multiple angles",
    ...
    },
    {
      ...
      icon: "📋",
      description:
        "You choose materials at our studio with samples in hand. Full itemised quotation presented. We start only after your written approval",
      image: "/Residentialimages/Material Selection.webp",
    },
    {
      step: "04",
      title: "Fabrication & Site Work",
      icon: "🔨",
      description:
        "Cabinets are precision-fabricated at our facility. Civil, electrical, and tiling work runs on-site simultaneously — minimising your total project time",
    ...
    },
    {
      ...
      icon: "✨",
      description:
        "Cabinets installed, countertops fitted, appliances coordinated, hardware adjusted and tested. Full quality check before we hand over",
        ...
        >
          ...
          <div className="text-center max-w-3xl mx-auto mb-12 lg:mb-16">
            <h2 className="mb-4 mt-6 text-[18px] font-black leading-[1.2] text-black sm:text-[32px] lg:text-[40px]">
              How Your Modular Kitchen{""}
              <span className="text-green-700"> Project Works</span>
            </h2>
          </div>
...
export default ModularKitchenProcess;
