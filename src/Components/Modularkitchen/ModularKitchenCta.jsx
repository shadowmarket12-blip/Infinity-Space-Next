          ...
          >
            <div className="relative p-6 sm:p-8 lg:p-12">
              ...
              <div className="text-center mb-10 sm:mb-12 lg:mb-16">
                <h2 className="mb-4 mt-6 text-[18px] font-black leading-[1.2] text-black sm:text-[32px] lg:text-[45px]">
              ...
              >
                <p className="text-black text-sm sm:text-base lg:text-lg leading-relaxed mb-4">
                  Good kitchen design is not about choosing the most expensive
                  finish — it is about getting the layout, the materials, and
                  the details right from the start. Our interior designers in
                  Bhubaneswar will visit your space, take precise measurements,
                  and show you your new kitchen in 3D at no charge. Contact us
...
export default ModularKitchenCta;
