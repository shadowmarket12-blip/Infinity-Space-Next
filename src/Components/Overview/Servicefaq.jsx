  ...
  const faqs = [
    {
      ...
      answer:
        "Interior design costs depend on space size, material preferences, customization requirements, and execution scope. Smart planning and practical material selection help create functional and visually appealing interiors within different budget ranges.",
    },
    {
      question: "Can affordable interior design still look premium?",
      answer:
        "Yes, thoughtful layouts, balanced lighting, smart material selection, and efficient space planning can create interiors that feel elegant and visually refined without excessive spending.",
    },
    {
      question:
        "How do interior designers help reduce unnecessary interior expenses?",
      answer:
        "Professional interior planning helps avoid poor space utilization, material wastage, impractical layouts, and execution mistakes that often increase project costs later.",
    },
    {
      question: "Why is space planning important for modern homes?",
      answer:
        "Good space planning improves storage efficiency, movement flow, functionality, organization, and overall living comfort within the available area.",
    },
    {
      question: "Can I get a modular kitchen within a reasonable budget?",
      answer:
        "Yes, modular kitchens can be designed within practical budget ranges by choosing suitable layouts, materials, finishes, and storage solutions according to your space and requirements.",
    },
    {
      question: "Are turnkey interior solutions better for project management?",
      answer:
        "Turnkey interior execution improves coordination, reduces delays, simplifies communication, and helps manage the project more efficiently from planning to completion.",
    },
    {
