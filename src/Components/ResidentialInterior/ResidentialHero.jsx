    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-[90vh] max-w-[1450px] items-center px-4 py-28 sm:px-6 lg:px-14">
        <div className="max-w-4xl">
          ...
          >
            Home Interior Design in Bhubaneswar That Feels Completely,
            Beautifully Yours
          </motion.h1>
          ...
          <Link href="/">
            ...
            >
              Award-worthy residential interiors crafted for the way Bhubaneswar
              families actually live — climate-smart, Vastu-conscious, delivered
              on time, and designed to last a lifetime.
            </motion.h2>
          </Link>
