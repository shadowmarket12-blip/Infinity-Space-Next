            ...
            <div className="relative p-6 sm:p-8 lg:p-12">
              ...
              >
                <p className="text-black text-sm sm:text-base lg:text-lg leading-relaxed mb-4">
                  Your dream home is not a luxury reserved for someone else — it
                  is a project that Infinity Space Odisha is ready to make real,
                  on your timeline and within your budget. Whether you are a
                  first-time homeowner excited about designing your new flat, or
                  an experienced homeowner ready to finally give your home the
                  interior it deserves, we are here to help.
                </p>
                <p className="text-black text-sm sm:text-base lg:text-lg leading-relaxed">
                  Hundreds of Bhubaneswar families have trusted us with the
                  spaces they live their lives in. We take that trust seriously
                  — and we deliver on it, every time.
                </p>
              </motion.div>
...
export default ResidentialRoomCta;
